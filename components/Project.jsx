    ...
    <section className="text-gray-400 body-font bg-gray-900 overflow-hidden" >
      <div className="container px-5 py-24 mx-auto overflow-hidden">
        ...
        <div className="flex flex-wrap -m-4">
          ...
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="h-full bg-gray-800 bg-opacity-40 p-6 rounded-lg hover:bg-gray-700">
              <a href="https://plant-colleciton-grid.web.app/" target="_blank"><img className="h-40 rounded w-full object-cover object-center mb-6" src="images/collectionGridPic.png" alt="content" /></a>
              <h3 className="tracking-widest text-green-400 text-xs font-medium title-font"></h3>
              <h2 className="text-lg text-white font-medium title-font mb-4">Plant Collection Grid</h2>
              <p className="leading-relaxed text-base">Plant collection grid is a website that allows users to see plant collections.</p>
            </div>
          </div>
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="h-full bg-gray-800 bg-opacity-40 p-6 rounded-lg hover:bg-gray-700">
