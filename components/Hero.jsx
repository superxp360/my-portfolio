    ...
    return(
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mb-0 mb-10">
            <img className="object-cover object-center rounded-lg border-green-500 border-8" alt="hero" src="/images/mePic.jpg" />
          </div>
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p className="mb-8 leading-relaxed text-left"> I'm currently a student at <strong><a href="https://bocacode.com/" target="_blank" className="text-rose-500">Boca Code</a></strong>, where I'm learning the necessary skills and technologies to become a successful software engineer. I'm driven to learn and grow in this field, and I'm excited about the endless possibilities that software engineering offers. With dedication and hard work, I know that I can contribute to the development of innovative solutions that can positively impact people's lives. I'm eager to see where my journey in software engineering will take me, and I'm committed to making the most of every opportunity to learn and grow. </p>
