      ...
      <section className="relative text-gray-600 body-font">
        ...
        <div className="container relative mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="z-10 relative lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                ...
                <a href="https://www.linkedin.com/in/kevin-fernandez-/" target="_blank" className="inline-flex items-center justify-center mr-12 h-16 w-28 text-white bg-blue-400 border-0 focus:outline-none hover:bg-blue-500 rounded text-lg">
                    <img
                        className="h-16 w-16"
                        alt="LinkedIn Button"
                    ...
                    <a href="https://github.com/superxp360" target="_blank" className="ml-4 inline-flex items-center justify-center text-gray-700 bg-green-500 border-0 h-16 w-28 focus:outline-none hover:bg-green-600 rounded text-lg">
                        <img
                            className="h-11 w-11"
                            alt="LinkedIn Button"
